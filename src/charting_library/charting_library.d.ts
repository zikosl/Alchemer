...
export interface StandardFormattersDependenciesMapping {
	...
	[StandardFormatterName.Symbol]: SymbolFormatterDependencies | SymbolFormatterDependenciesWithoutMessage;
	[StandardFormatterName.Side]: SideFormatterDependencies;
	[StandardFormatterName.PositionSide]: SideFormatterDependencies;
	[StandardFormatterName.Text]: string[];
	[StandardFormatterName.Type]: TypeFormatterDependencies;
	[StandardFormatterName.FormatPrice]: PriceFormatterDependencies;
	[StandardFormatterName.FormatPriceForexSup]: PriceFormatterDependencies;
	[StandardFormatterName.Status]: StatusFormatterDependencies;
	[StandardFormatterName.Date]: DateFormatterDependencies;
	[StandardFormatterName.LocalDate]: DateFormatterDependencies;
	[StandardFormatterName.DateOrDateTime]: DateFormatterDependencies;
	[StandardFormatterName.LocalDateOrDateTime]: DateFormatterDependencies;
	[StandardFormatterName.Fixed]: FixedFormatterDependencies;
	[StandardFormatterName.FixedInCurrency]: FixedInCurrencyFormatterDependencies;
	[StandardFormatterName.VariablePrecision]: VariablePrecisionFormatterDependencies;
	[StandardFormatterName.Pips]: PipsFormatterDependencies;
	[StandardFormatterName.IntegerSeparated]: IntegerSeparatedFormatterDependencies;
	[StandardFormatterName.FormatQuantity]: QuantityFormatterDependencies;
	[StandardFormatterName.Profit]: ProfitFormatterDependencies;
	[StandardFormatterName.ProfitInInstrumentCurrency]: ProfitInInstrumentCurrencyFormatterDependencies;
	[StandardFormatterName.Percentage]: PercentageFormatterDependencies;
	[StandardFormatterName.MarginPercent]: MarginPercentFormatterDependencies;
	[StandardFormatterName.Empty]: EmptyFormatterDependencies;
}

// Define the interfaces or types for each formatter's dependencies
interface SymbolFormatterDependencies {
	brokerSymbolProperty: string;
	symbolProperty: string;
	message: string;
}

interface SymbolFormatterDependenciesWithoutMessage {
	brokerSymbolProperty: string;
	symbolProperty: string;
}

interface SideFormatterDependencies {
	sideProperty: string;
}

interface TypeFormatterDependencies {
	orderTypeProperty: string;
	parentIdProperty: string;
	stopTypeProperty: string;
}

interface PriceFormatterDependencies {
	priceProperty: string;
}

interface StatusFormatterDependencies {
	statusProperty: string;
}

interface DateFormatterDependencies {
	dateProperty: string;
}

interface FixedFormatterDependencies {
	valueProperty: string;
}

interface FixedInCurrencyFormatterDependencies {
	valueProperty: string;
	currencyProperty: string;
}

interface VariablePrecisionFormatterDependencies {
	valueProperty: string;
}

interface PipsFormatterDependencies {
	pipsProperty: string;
}

interface IntegerSeparatedFormatterDependencies {
	valueProperty: string;
}

interface QuantityFormatterDependencies {
	qtyProperty: string;
}

interface ProfitFormatterDependencies {
	profitProperty: string;
}

interface ProfitInInstrumentCurrencyFormatterDependencies {
	profitProperty: string;
	currencyProperty: string;
}

interface PercentageFormatterDependencies {
	valueProperty: string;
}

interface MarginPercentFormatterDependencies {
	valueProperty: string;
}

interface EmptyFormatterDependencies {}
 ...
 */
export interface ISeriesStudyResult {
  time: number;
  open: number;
  high: number;
  low: number;
